...
public class CursosTest {
	...
	public void setUp() throws Exception {
		cursos = new CursosCRUD("Info", "Programação", "LB02", "RS56677TU", "Pendrive", "Deitel", "01/01/01", "01/03/01", "09:09", 129, 210.90);
		copia = new CursosCRUD("Info", "Programação", "LB02", "RS56677TU", "Pendrive", "Deitel", "01/01/01", "01/03/01", "09:09", 129, 210.90);
	}
	
	@Test
	public void test00Carregar() {
	
		CursosCRUD fixture = new CursosCRUD("Info", "Programação", "LB02", "RS56677TU", "Pendrive", "Deitel", "01/01/01", "01/03/01", "09:09", 129, 210.90);
